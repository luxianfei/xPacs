...
import com.xquant.xpacs.base.http.HttpListResult;
...
public class AnalysisWebComponentResponseAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
        ...
        List<Map<String,Object>> dataList = (List<Map<String,Object>>) body;
        BaseResultModel baseResultModel = analysisDataAdapter.doFormat(dataList);
