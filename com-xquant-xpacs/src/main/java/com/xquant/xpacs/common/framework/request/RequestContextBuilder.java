...
import java.util.Map;
 ...
 /**
 * @ClassName: IndexRequestContextBuilder
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author: deming.ye
 * @date: 2018年7月27日 上午9:18:00
 *
 */
public class RequestContextBuilder implements IRequestContextBuilder {
...
//    public static final String X_FORWARDED_FOR = "X-Forwarded-For";
    ...
    public RequestContextBuilder(FormattingConversionService conversionService) {
